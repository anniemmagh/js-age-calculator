...
let month = 1 + date.getDate();
let year = 1 + date.getFullYear();
const months = [31,28,31,30,31,30,31,31,20,31,20,31];
...
if(!i.value){
    ...
    monthInp.querySelector('small').innerText = "it's not a valid month";
    validator = false;
}else if (dayInp.value > 31){
    dayInp.style.borderColor = 'red';
    dayInp.querySelector('small').innerText = "This isn't a valid day";
    validator = false;
}else{
